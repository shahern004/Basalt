<script lang="ts">
	...
	import { WEBUI_BASE_URL,
		     LITELLM_API_BASE_URL,
			 OPENAI_API_BASE_URL,
			 DEFAULT_SYSTEM_PROMPT,
			 DEFAULT_WEB_API_SPEAKER
	} from '$lib/constants';
	...
	const initNewChat = async () => {
		...
		// Update and enforce initial session settings
		let _settings = JSON.parse(localStorage.getItem('settings') ?? '{}');
		_settings.system = DEFAULT_SYSTEM_PROMPT;
		_settings.audio = {speaker : DEFAULT_WEB_API_SPEAKER};
...
<div class="max-height w-full flex flex-col">
