<script lang="ts">
	...
	import WarnBanner from '$lib/components/layout/WarnBanner.svelte';
...
{#if loaded}
	...
	<div class="app relative">
		...
		<WarnBanner/>
		<div
			class=" text-gray-700 dark:text-gray-100 bg-white dark:bg-gray-900 overflow-auto flex flex-row"
		>
			<Sidebar />
