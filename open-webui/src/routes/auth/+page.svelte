...
<!-- Logo in the top right removed for a seamless auth -->
...
<!-- <div class=" bg-white dark:bg-gray-900 w-full flex justify-center font-mona"> -->
	...
	<!-- Forms removed for a seamless auth -->
	<!-- <div class="w-full sm:max-w-lg px-4 flex flex-col">
