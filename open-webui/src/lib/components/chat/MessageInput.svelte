<script lang="ts">
	...
	import { SUPPORTED_FILE_TYPE, SUPPORTED_FILE_EXTENSIONS, APP_NAME } from '$lib/constants';
		...
		<div class="max-w-3xl px-2.5 mx-auto inset-x-0">
			<div class=" pb-2">
				...
				<div class="mt-1.5 text-xs text-gray-500 text-center">
					{$i18n.t(`"${APP_NAME}" is based on `)}
					<a href="https://github.com/open-webui/open-webui" target="_blank" class="underline text-gray-400">
						Open-WebUI</a>. Language models may hallucinate and provide unreliable information.<br>All responses should be checked for accuracy.
				</div>
			</div>
		</div>
	</div>
